  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden animate-scale-in">
        {/* Header con degradado según categoría */}
        <div className={`p-6 text-white bg-gradient-to-r ${category.gradient}`}>
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1">
              <h2 className="text-white font-bold text-xl">{formatPlayerName(player.name)}</h2>
