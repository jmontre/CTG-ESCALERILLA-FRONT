        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={sectionClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Vacío = no compite</p>
              </div>
              <div>
            ...
            <p className="text-xs text-gray-500 mb-4">Total: {formData.wins + formData.losses} partidos</p>
            ...
            <div className="mb-3">
              ...
              <div className="flex gap-2">
                ...
                <button type="button" onClick={() => { const d = new Date(); d.setHours(d.getHours()+24); setFormData({...formData, immune_until: d.toISOString().slice(0,16)}); }}
                  className="px-3 py-2 bg-blue-100 text-blue-700 rounded-lg text-xs hover:bg-blue-200">+24h</button>
                <button type="button" onClick={() => setFormData({...formData, immune_until: ''})}
                  className="px-3 py-2 bg-gray-100 text-gray-600 rounded-lg text-xs">Quitar</button>
              </div>
            </div>
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button type="button" onClick={() => { const d = new Date(); d.setHours(d.getHours()+24); setFormData({...formData, vulnerable_until: d.toISOString().slice(0,16)}); }}
                  className="px-3 py-2 bg-orange-100 text-orange-700 rounded-lg text-xs hover:bg-orange-200">+24h</button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select value={formData.member_type}
                  onChange={e => setFormData({...formData, member_type: e.target.value, parent_id: ''})} className={inputClass}>
              ...
              {formData.member_type === 'hijo_socio' && (
                <div>
                  ...
                  <select value={formData.parent_id}
                    onChange={e => setFormData({...formData, parent_id: e.target.value})} className={inputClass}>
              ...
              <div className="md:col-span-2">
                <label className="flex items-center gap-3 cursor-pointer p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">No podrá hacer nuevas reservas</p>
                  </div>
                </label>
              </div>
            </div>
            ...
            {loadingReservations ? (
              ...
              <>
                ...
                {pastReservations.length > 0 && (
                  <>
                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Últimas canceladas/pasadas</p>
          ...
          <div className={sectionClass}>
            ...
            <select value={formData.admin_role}
              onChange={e => setFormData({...formData, admin_role: e.target.value})} className={inputClass}>
